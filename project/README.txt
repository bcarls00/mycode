...
This script will take the the current configuration file form the switch and output a summary to either a custom 
...
This script will take as a standardized, easy to read file and output a file that when ran in the switch will 
